					...
					(waiting.level === 3 ? (
						<div className="flex items-center font-semibold gap-2">
							...
							<div className="flex items-center gap-1">
								<span className="size-1.5 text-gray-600 animate-bounce rounded-full bg-current [animation-delay:-0.4s]" />
								<span className="size-1.5 text-gray-400 animate-bounce rounded-full bg-current [animation-delay:-0.2s]" />
								<span className="size-1.5 text-gray-200 animate-bounce rounded-full bg-current border" />
							</div>
						</div>
					) : waiting.level === 2 ? (
						<div className="flex items-center font-semibold gap-2">
